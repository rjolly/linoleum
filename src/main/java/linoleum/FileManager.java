...
public class FileManager extends Frame implements Runnable {
	...
	private final Icon newFolderIcon = new ImageIcon(getClass().getResource("newFolder.gif"));
	private final Icon upFolderIcon = new ImageIcon(getClass().getResource("upFolder.gif"));
	...
	private final Icon fileIcon = new ImageIcon(getClass().getResource("file.gif"));
	private final Icon directoryIcon = new ImageIcon(getClass().getResource("directory.gif"));
